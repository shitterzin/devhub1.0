...
export function Tweet({ tweet }) {
  ...
  return (
    <div className="border-b border-gray-900 p-4 hover:bg-gray-800 transition duration-200">
...
Tweet.propTypes = {
    tweet: PropTypes.shape({
      ...
      image: PropTypes.string, // Não é obrigatório, pois pode não ter uma imagem
    }).isRequired,
  };